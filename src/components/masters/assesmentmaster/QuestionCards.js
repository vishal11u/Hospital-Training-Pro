                ...
                <div className='rounded-md h-[46.5vh] -mt-2.5 overflow-y-auto scrollbar-thin scrollbar-thumb-rounded scrollbar-thumb-gray-500'>
                    ...
                    {questionData.length > 0 && (
                        <div className='flex gap-2 float-right mt-2'>
                            <button type='button' className='text-red-600 border border-red-600 rounded-md px-2 py-1 w-[120px]' onClick={resetAssessment}>Reset</button>
                            <button type='button' className='text-white rounded-md px-2 py-1 bg-green-600 w-[120px]' onClick={saveAssessment}>Save</button>
                        </div>
                    )}
                </div>
            ) : (
