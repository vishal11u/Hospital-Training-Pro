...
import editIcon from '../../../../../assets/masters/edit.svg';
    ...
    return (
        <div className=''>
            {questionData && questionData.length > 0 ? (
                <div className='rounded-md -mt-2 h-[58vh] overflow-y-auto'>
                    {questionData.map((question, index) => (
                        <div
                            key={index}
                            className='border mt-2 w-full rounded-md shadow border-[#CCCCCC]'
                            draggable
                    ...
                    {questionData.length > 0 && (
                        <div className='flex gap-2 float-right mt-2'>
                            <button className='text-red-600 border border-red-600 rounded-md px-2 py-1 w-[120px]' onClick={resetAssessment}>Reset</button>
                            <button className='text-white rounded-md px-2 py-1 bg-green-600 w-[120px]' onClick={saveAssessment}>Save</button>
                        </div>
                    )}
                </div>
            ) : (
