      ...
      <div className="mt-6">
        {!loading ? (
          assignCourses?.length > 0 ? (
            <div className="grid sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-4 gap-x-5 gap-y-3">
              {assignCourses.map((item) => (
                ...
                >
                  <div className="relative w-[340px] h-[210px]">
                    ...
                    <div className="absolute inset-0 md:right-16 lg:right-12 xl:right-28 2xl:right-7  flex items-center justify-center z-20">
                      <img
                        src={Play_svg}
                        alt="play_svg"
                        className="h-14 w-14"
